...
public class Student
{
    ...
    public Student(int id, String firstName, String lastName, String remarks) {
    }
    ...
    public static void createAttendanceTablef() {
        String createAttendanceTable = "CREATE TABLE IF NOT EXISTS student_quiz_attendance (" +
                "student_id INTEGER, " +
                "quiz_id INTEGER, " +
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(connectionUrl)) {
                PreparedStatement ps = connection.prepareStatement(createAttendanceTable);
                ps.execute();
