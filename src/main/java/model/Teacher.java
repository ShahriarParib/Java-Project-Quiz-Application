...
{
    private static Teacher loggedInTeacher;  // Static variable to store the logged-in teacher

    // Getters and setters for loggedInTeacher
    ...
    public Teacher( String firstName, String lastName, String mobile,Character gender, String email, String password) {
    ...
    public Teacher(Integer id, String firstName, String lastName, String mobile,Character gender,String email, String password) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
    ...
    public Teacher save()
    {
        ...
        try{
            String raw = "INSERT INTO teachers(%s,%s,%s,%s,%s,%s) VALUES(?,?,?,?,?,?)";
            String query =String.format(raw,
                    mydata.FIRST_NAME,
                    mydata.LAST_NAME,
                    mydata.MOBILE,
    ...
    public static ArrayList<Teacher>getinfo()
    {
    ...
    public void login() throws  SQLException,ClassNotFoundException,LoginException {
        ...
        String query = String.format("Select %s ,%s,%s,%s,%s from %s where %s = ? and %s =?;",
                mydata.ID, mydata.FIRST_NAME, mydata.LAST_NAME, mydata.MOBILE, mydata.GENDER, mydata.TABLE_NAME, mydata.EMAIL, mydata.PASSWORD);
        System.out.println(query);
        String connectionurl = "jdbc:sqlite:quiz.db";
        System.out.println("Connecting to database...");
        Class.forName("org.sqlite.JDBC");
        ...
        if (result.next()) {
            ...
            Teacher.setLoggedInTeacher(this);
        }
        else {
