...
public class Teachersignup implements Initializable {
    ...
    public void backfromteacher(ActionEvent actionEvent) {
        try {
    ...
    private String vadilate(Teacher student) {
    ...
    public void saveteacher (ActionEvent actionEvent){
        System.out.println("Saving new teacher...");
        ...
        Teacher s = new Teacher(firstName, lastName, mobile, gen, email, password);
        ...
        if (s != null) {
            ...
            Notifications.create()
                    .title("Success")
                    .text("Teacher has been registered")
                    .position(Pos.CENTER)
                    .hideAfter(Duration.seconds(2))
                    .showInformation();
            resetform();
            ...
            Notifications.create()
                    .title("Failed")
                    .text("Teacher registration failed.")
                    .position(Pos.CENTER)
                    .hideAfter(Duration.seconds(2))
                    .showError();
        }
